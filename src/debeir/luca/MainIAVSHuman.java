...
public class MainIAVSHuman {
	...
	public static void main(String[] args) {
		...
		while (res == false) {
			...
			System.out.println(" ");
			System.out.println("Grille de défense de " + enemy.getNomJoueur() + " :");
			System.out.println(" ");
			current.getGridAttack();
			System.out.println(" ");
	...
	public static IALevelZero initIALevelZero(String nomJoueur) {
		...
		IALevelZero IA0 = new IALevelZero(nomJoueur, flotteIA, listAttack, listTouched, listAttack2, scoreIA, listNextMissile, tirPrec);
	...
	public static IALevelOne initIALevelOne(String nomJoueur) {
		...
		IALevelOne IA1 = new IALevelOne(nomJoueur, flotteIA, listAttack, listTouched, listAttack2, scoreIA, listNextMissile, tirPrec);
	...
	public static IALevelTwo initIALevelTwo(String nomJoueur) {
		...
		IALevelTwo IA2 = new IALevelTwo(nomJoueur, flotteIA, listAttack, listTouched, listAttack2, scoreIA, listNextMissile, tirPrec);
	...
	public static Ship initShip(Player player) {
		...
		String x = scan.next();
		Coordinate coord1 = new Coordinate(x,false);
		while(coord1.validCoordinate() == false) {
		...
		String y = scan.next();
		Coordinate coord2 = new Coordinate(y,false);
		while(coord2.validCoordinate() == false) {
			System.out.println("Mauvaise coordonnée. Entrez une nouvelle coordonnée de départ de votre bateau : ");
			y = scan.next();
			coord2.setCoord(y);
		}
